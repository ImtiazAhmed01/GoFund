...
//             <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg space-y-6  dark:bg-gray-900 dark:text-white">
//                 <h2 className="text-3xl font-semibold text-center text-green-600">Update Campaign</h2>
//                 <form onSubmit={handleSubmit} className="space-y-4">
//                     <div className="flex flex-col space-y-2">
//                         <label className="font-medium text-gray-500">Campaign Image</label>
//                         <input
//                             type="text"
//                             name="image"
...
const UpdateCampaign = () => {
    ...
    const navigate = useNavigate();
    const [campaign, setCampaign] = useState({
        imageUrl: '', // Fixed key to match backend
        campaignTitle: '',
        campaignType: '',
        description: '',
        minimumDonationAmount: '',
    ...
    if (isLoading) {
        return <div className="text-center mt-10">Loading campaign details...</div>;
    }

    return (
        <div className='bg-gray-800 pt- mt-5'>
            <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg space-y-6 dark:bg-gray-900 ">
                <h2 className="text-3xl font-semibold text-center text-green-600">Update Campaign</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* Campaign Image URL */}
                    <div className="flex flex-col space-y-2">
                        <label className="font-medium text-gray-500">Campaign Image URL</label>
                        <input
                            type="text"
                            name="imageUrl"
                            value={campaign.imageUrl}
                    ...
                    {/* Campaign Title */}
                    <div className="flex flex-col space-y-2">
                        <label className="font-medium text-gray-500">Campaign Title</label>
                        <input
                            type="text"
                            name="campaignTitle"
                            value={campaign.campaignTitle}
                    ...
                    {/* Campaign Type */}
                    <div className="flex flex-col space-y-2">
                        <label className="font-medium text-gray-500">Campaign Type</label>
                        <input
                            type="text"
                            name="campaignType"
                            value={campaign.campaignType}
                    ...
                    <div className="flex flex-col space-y-2">
                        <label className="font-medium text-gray-500">Minimum Donation Amount</label>
                        <input
                            type="number"
                            name="minimumDonationAmount"
                            value={campaign.minimumDonationAmount}
                    ...
                    {/* User Email */}
                    <div className="flex flex-col space-y-2">
                        <label className="font-medium text-gray-500">User Email</label>
                        <input
                            type="email"
                            name="userEmail"
                            value={campaign.userEmail}
                    ...
                    {/* User Name */}
                    <div className="flex flex-col space-y-2">
                        <label className="font-medium text-gray-500">User Name</label>
                        <input
                            type="text"
                            name="userName"
                            value={campaign.userName}
