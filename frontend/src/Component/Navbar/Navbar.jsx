...
//             <div className={`navbar ${darkMode ? "bg-gray-900 text-white" : "bg-base-100 text-black"} -mb-7`}
//                 style={{ transition: "background 0.3s, color 0.3s" }}>
//                 {/* Navbar Start */}
//                 <div className="navbar-start">
//                     <div className="dropdown">
...
//                             />
//                             {dropdownOpen && (
//                                 <div className={`absolute right-0 mt-2 w-48 shadow-lg rounded-md py-2 z-10 ${darkMode ? "bg-gray-800 text-white" : "bg-white text-black"}`}>
