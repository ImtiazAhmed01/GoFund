...
const Navbar = () => {
    ...
    return (
        <div className={darkMode ? "bg-black text-white" : "bg-cyan-200 text-black"}>
            {/* Optional welcome banner */}
            {user && user.displayName && (
                <div className={darkMode ? "bg-gray-800 text-white" : "bg-gray-100 text-black"}>
                    <span className="text-sm font-medium px-4 py-1">Welcome, {user.displayName}!</span>
                </div>
            )}

            <div className="navbar -mb-7 px-4" style={{ transition: "background 0.3s, color 0.3s" }}>
                {/* Navbar Start */}
                <div className="navbar-start">
                    <div className="dropdown">
                        <button tabIndex={0} className="btn btn-ghost lg:hidden">
                        ...
                        <ul
                            tabIndex={0}
                            className={`menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52 ${darkMode ? "bg-gray-800 text-white" : "bg-white text-black"
                                }`}
                        >
                            {links}
                        </ul>
                ...
                <div className="navbar-end gap-4 flex items-center relative">
                    {user ? (
                        <div className="flex items-center gap-4">
                            <button
                                onClick={toggleTheme}
                                className={`px-4 py-2 rounded ${darkMode ? "bg-gray-200 text-black" : "bg-gray-800 text-white"}`}
                            >
                                {darkMode ? "Light Mode" : "Dark Mode"}
                            </button>
